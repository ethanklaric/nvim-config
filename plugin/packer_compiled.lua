...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-markdown', 'limelight.vim', 'vim-pencil', 'markdown-preview.nvim', 'goyo.vim'}, { ft = "markdown" }, _G.packer_plugins)]]
